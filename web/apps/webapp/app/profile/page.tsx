      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="pt-20 px-4 text-center">
          ...
          <div className="flex justify-around mb-6">
            ...
            <div className="text-center">
              <div className="text-lg font-bold">{user.stats.raves}</div>
              <div className="text-sm text-muted-foreground">Takdir</div>
            </div>
          </div>
          ...
          <div className="mb-6 px-4">
            <div className="flex justify-between mb-2">
              <span className="text-sm font-medium">Seviye {user.level}</span>
        ...
        >
          <TabsList className="grid w-full grid-cols-3 bg-white rounded-lg p-1 gap-1">
            <TabsTrigger
              value="posts"
              className="py-2 text-sm data-[state=active]:bg-emerald-500 data-[state=active]:text-white"
            >
