...
export default function HomePage() {
  ...
  const samplePosts = [
    ...
    },
    {
      ...
      time: "1 gün önce",
      images: [
        "https://images.unsplash.com/photo-1551232864-3f0890e580d9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=688&q=80",
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 p-4">
              {samplePosts
                ...
                .map((post) => (
                  <article
                    key={post.id}
                    className="relative aspect-square bg-white rounded-xl overflow-hidden cursor-pointer hover:shadow-md transition-all"
                    onClick={() => handlePostClick(post)}
                  >
                    <Image
                      src={post.images[0]}
