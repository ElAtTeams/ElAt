...
import { MapPin, Users, Shield, MessageCircle, Star, Smartphone, Home, User } from "lucide-react"
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">YanKapı Nasıl Çalışır?</h1>
              ...
              <div className="relative mx-auto w-[280px] h-[580px]">
                <div className="relative w-full h-full bg-black rounded-[3rem] border-[14px] border-black shadow-xl">
                  ...
                  <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden">
                    <img src="/app-screen-1.png" alt="YanKapı Mobil Uygulama" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    App Store veya Google Play'den YanKapı uygulamasını indirin. Hızlı ve güvenli bir şekilde hesabınızı
                    oluşturun.
                  </p>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Kimlik ve adres doğrulaması yapın. Güvenli bir ortam için tüm kullanıcılarımız doğrulanmış
                    profillere sahiptir.
                  </p>
                </div>
              </div>
            ...
            <div className="order-1 md:order-2">
              <div className="relative mx-auto w-[280px] h-[580px]">
                <div className="relative w-full h-full bg-black rounded-[3rem] border-[14px] border-black shadow-xl">
                  ...
                  <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden">
                    <img src="/app-screen-2.png" alt="YanKapı Mobil Uygulama" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
