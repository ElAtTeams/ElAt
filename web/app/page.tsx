...
const slides = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80",
    tags: ["Sosyal", "Etkinlik", "Topluluk"]
  },
  {
    title: "Yardımlaşma Ağı",
    description: "İhtiyaç sahipleriyle yardımseverleri buluşturuyoruz",
    image: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1949&q=80",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[calc(100vh-8rem)]">
            <div>
              <h1 className="text-5xl md:text-7xl font-bold mb-8 text-gray-900">
                ...
                <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-emerald-700">Güçlendiriyoruz</span>
              </h1>
              <p className="text-xl text-gray-600 mb-12 max-w-2xl">
                YanKapı ile mahallenizdeki komşularınızla güvenli bir şekilde tanışın,
                yardımlaşın ve dayanışmayı güçlendirin.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white text-lg px-8 py-6 rounded-2xl">
                  <Users className="w-6 h-6 mr-2" />
                  Hemen Katıl
                </Button>
                <Button size="lg" variant="outline" className="border-2 border-emerald-500 text-emerald-600 hover:bg-emerald-50 text-lg px-8 py-6 rounded-2xl">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white rounded-3xl p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-900/10 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Yakınınızdaki komşularınızla güvenli bir şekilde tanışın ve iletişime geçin.</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-900/10 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Doğrulanmış kullanıcılar ile güvenli iletişim kurun ve topluluk güvenini artırın.</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-900/10 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Şifreli mesajlaşma sistemi ile güvenli iletişim kurma imkanı.</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-900/10 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Yardımlaşın, puan kazanın ve özel rozetler ile topluluğa katkınızı gösterin.</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-pink-900/10 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Mahalle etkinliklerini takip edin ve organizasyonlara katılın.</p>
            </div>
