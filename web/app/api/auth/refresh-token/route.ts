...
export async function POST(request: NextRequest) {
  try {
    ...
    const connection = await createConnection("mysql") // 'mysql' olarak belirtildi
    ...
    return NextResponse.json({ success: false, error: "Token yenileme sırasında bir hata oluştu." }, { status: 500 })
  }
}
