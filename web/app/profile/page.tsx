    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="relative">
          <div
            className="h-32 w-full bg-gradient-to-r from-emerald-600 to-emerald-500"
          />
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-500">
                  Henüz bir aktivite kaydınız bulunmuyor
                </p>
              </CardContent>
            </Card>
          )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {user.badges.map((badge, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="flex items-center py-1 px-3 bg-gray-50"
                      >
      ...
      {/* Bottom Navigation */}
      <div className="sticky bottom-0 bg-white border-t py-2 px-6 shadow-lg">
        <div className="flex justify-between items-center">
          <Button variant="ghost" className="flex flex-col h-auto text-gray-500">
          ...
          <Button
            variant="ghost"
            className="flex flex-col h-auto text-emerald-600"
          >
