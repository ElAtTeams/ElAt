...
import { Home, Star, Users, Bell, User, Heart, Mail, Phone, MapPin, Facebook, Twitter, Instagram, Youtube } from 'lucide-react'
import { Button } from '@/components/ui/button'

export const metadata = {
  title: 'YanKapı - Komşuluk Platformu',
  description: 'YanKapı ile mahallenizdeki komşularınızla güvenli bir şekilde tanışın, yardımlaşın ve dayanışmayı güçlendirin.',
  generator: 'Next.js',
}
