...
export default function MessagesPage() {
  ...
  const messages = [
    {
      ...
      preview: "Merhaba, bu hafta sonu köpeğinizi yürütebilirim. Kendim de golden retriever sahibiyim...",
      time: "2 saat önce",
      read: false,
      type: "help-offer",
      category: "community",
    ...
    },
    {
      ...
      preview: "Merhaba, kullanmadığım birkaç kitabım var. İlgilenirseniz getirebilirim...",
      time: "1 gün önce",
      read: true,
      type: "share",
      category: "individual",
    ...
    },
    {
      ...
      preview: "Sevgili üyelerimiz, topluluk kurallarımızda küçük güncellemeler yapılmıştır...",
      time: "3 gün önce",
      read: true,
      type: "system",
      category: "community",
    ...
    },
    {
      ...
      preview: "Teşekkür ederim! Yardım teklifinizi kabul etmek istiyorum. Detayları konuşabilir miyiz?",
      time: "5 gün önce",
      read: true,
      type: "help-accept",
      category: "individual",
  ...
  const filteredMessages = messages.filter((msg) => {
    ...
    if (activeTab === "starred") return starredMessages.includes(msg.id) && matchesSearch
    if (activeTab === "pinned") return pinnedMessages.includes(msg.id) && matchesSearch
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            {filteredMessages.length === 0 ? (
              <Card className="border-0 shadow-sm">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Mesaj bulunamadı</h3>
                  <p className="text-gray-500 mb-6">Arama kriterlerinize uygun mesaj bulunamadı</p>
                  <Button
                    onClick={() => {
                      setSearchQuery("")
                      setActiveTab("inbox")
                    ...
                    {filteredMessages.map((message) => (
                      ...
                      >
                        <div className="flex items-start space-x-3">
                            ...
                            <div className="flex justify-between items-start">
                              ...
                              >
                                ...
                                {message.senderLocation && (
                                  <span className="text-gray-500 font-normal"> ({message.senderLocation})</span>
                                )}
                              </h4>
                              <h5 className={`text-sm truncate ${!message.read ? "font-semibold" : "font-normal"}`}>
                                {message.subject}
                              </h5>
                            </div>
                          ...
                          {!message.read && <span className="w-2 h-2 rounded-full bg-emerald-500 mt-3"></span>}
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          <div className="h-full flex flex-col">
              ...
              <div className="flex items-center justify-between">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48">
                    ...
                    <DropdownMenuItem onClick={() => togglePin(selectedMessage.id)}>
                      {pinnedMessages.includes(selectedMessage.id) ? (
                        <>
            ...
            <div className="flex-1 overflow-auto p-4 space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <h3 className="font-medium">
                      ...
                      {selectedMessage.senderLocation && (
                        <span className="text-gray-500 font-normal"> ({selectedMessage.senderLocation})</span>
                      )}
                    </h3>
                    <span className="text-sm text-gray-500">{selectedMessage.time}</span>
                  </div>
                  <p className="text-sm text-gray-500">
                    {selectedMessage.category === "community" ? "Topluluk Mesajı" : "Bireysel Mesaj"}
                  </p>
                </div>
              </div>
              {/* Mesaj Body */}
              <div className="prose prose-sm max-w-none">
                <p>Merhaba,</p>
                <p>
                  {selectedMessage.preview} Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam euismod,
                  nisl eget aliquam ultricies, nunc nisl aliquet nunc, quis aliquam nisl nunc eu nisl.
                </p>
                <p>
                  Saygılarımla,
                  <br />
              ...
              {selectedMessage.attachments.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {selectedMessage.attachments.map((file: any, index: number) => (
                ...
                <Card className="border-emerald-200 bg-emerald-50">
                  <CardContent className="p-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-medium text-emerald-800">Yardım Teklifi</h4>
                        <p className="text-sm text-emerald-700">Bu kişi size yardım teklif ediyor</p>
                      </div>
                    </div>
          ...
          <div className="bg-white rounded-lg w-full max-w-md max-h-[90vh] flex flex-col">
            ...
            <div className="p-4 space-y-4 flex-1 overflow-auto">
              ...
              <div className="space-y-2 flex-1">
                ...
                <Textarea placeholder="Mesajınızı buraya yazın..." className="min-h-[200px]" />
              </div>
              <div className="border rounded-lg p-4 text-center bg-gray-50">
                <Paperclip className="h-6 w-6 mx-auto text-gray-400 mb-2" />
                <p className="text-sm text-gray-500 mb-3">Dosyaları buraya sürükleyip bırakın veya</p>
                <Button variant="outline" size="sm">
                  Dosya Seç
                </Button>
                <p className="text-xs text-gray-400 mt-3">PDF, JPG, PNG formatlarında, max 10MB</p>
              </div>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40">
        <div className="flex justify-around items-center py-2">
          ...
          {/* Mesajlar */}
          <Link href="/dashboard/messages" className="flex flex-col items-center justify-center text-emerald-600">
